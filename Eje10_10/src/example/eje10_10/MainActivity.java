...
public class MainActivity extends Activity {
	...
	private ServiceConnection connexio = new ServiceConnection() {
		...
		public void onServiceDisconnected(ComponentName name) {
			servei = null;
			Toast.makeText(MainActivity.this, "Connectat a Servei", Toast.LENGTH_SHORT).show();
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		botoConnectar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				MainActivity.this.bindService(new Intent(MainActivity.this, ServeiRemot.class), connexio, Context.BIND_AUTO_CREATE);
			}
		});
